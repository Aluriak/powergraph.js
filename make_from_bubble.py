...
from data import JS_HEADER, JS_MIDDLE, JS_FOOTER, JS_NODE_LINE, JS_EDGE_LINE, JS_FALSEDGE_LINE, JS_MOUSEOVER_SHOW_CALLBACKS, JS_MOUSEOVER_WIDTH_CALLBACKS


FALSE_EDGE_ON_HOVER = False
